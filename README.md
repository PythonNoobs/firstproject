...
- **Реестр серверов(serverapp) (@dgon_kondrasov Eugene Karandasov)**
...
- **Подсистема регистрации\авторизации (authapp)(недоступно)**
- **Подсистема администрирования(adminapp) (недоступно)**
