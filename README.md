...
- страница "дни рождения сотрудников". Дни рождения отсортировать от ближайшего дня рождения к текущей дате.

Дополнительно к реализации:
- Реализовать отображение дня рождения в формате "день месяц" на странице "дни рождения сотрудников"
- Строки, где дни рождения сегодня подсвечивать зеленым цветом, дни рождения в ближайшие 3 дня подсвечивать желтым цветом.
Реализовать добавление фото в карточку сотрудника
